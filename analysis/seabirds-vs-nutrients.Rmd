...
#ggsave(filename = "../outputs/figures/figure2.png", 
#       plot = figure2,
#       width = 20, 
#       height = 10,
#      units = "cm",
...
# Can save the plot with ggsave()
#ggsave(filename = "../outputs/figures/figure2_size.png", 
#       plot = figure2_size,
#       width = 20, 
...
#ggsave(filename = "../outputs/figures/figure2_size_exp.png",        plot = figure2_size_exp,      width = 20,     height = 10,      units = "cm",     dpi = 300)

```


##re-plot for final figure (because alternative dag doesn't change this part)
```{r}
...
#ggsave(filename = "../outputs/figures/fig_turf_n_seabird_post_plot_alt.pdf", plot = turf_post_plot_alt,  width = 8,   height = 5,  units = "cm", dpi = 300)
```
...
#Save the plot with ggsave()
#ggsave(filename = "../outputs/figures/fig_turf_n_seabird_post_plot_alt_size.pdf", plot = turf_post_plot_alt_size,  width = 8,   height = 5,  units = "cm", dpi = 300)
```
