...
#                         NMDS1    NMDS2     r2 Pr(>r)    
#turf                   0.53747  0.84329 0.1181  0.349   
#structure              0.91380  0.40617 0.2573  0.081 . 
#Exposure_J_m3          0.87481  0.48447 0.1135  0.377   
#mean_turf_prod_mm_day  0.95491 -0.29688 0.5232  0.004 **
#mean_turf_n15          1.00000  0.00000 0.3097  0.056 . 
#pred_biomass_kg_ha     0.28121 -0.95964 0.1495  0.241 
...
#                         NMDS1    NMDS2     r2 Pr(>r)    
#turf                   0.15633 -0.98770 0.0022  0.984   
#structure              0.99907  0.04302 0.4716  0.004 **
#Exposure_J_m3          0.65663  0.75421 0.1395  0.295   
#mean_turf_prod_mm_day  0.79096 -0.61187 0.3580  0.021 * 
#mean_turf_n15          1.00000  0.00000 0.2616  0.070 . 
#pred_biomass_kg_ha    -0.86062 -0.50924 0.0763  0.520   
...
ggsave(filename = "../outputs/figures/supp_nmds_fig.png", 
       plot = supp_nmds_fig,
       width = 22, 
      height = 10,
      units = "cm",
...
ggsave(filename = "../outputs/figures/supp_nmds_fig.pdf", 
      plot = supp_nmds_fig,
       width = 25, 
       height = 10,
      units = "cm",
